...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top py-2 shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="./assets/logo.png" alt="Logo" width="100" height="40" class="d-inline-block align-top">
            </a>
...
$company_info = [
    "name" => "E-Shop",
    "description" => "Welcome to e-MAX, your number one source for all things. We're dedicated to giving you the very best products, with a focus on dependability, customer service, and uniqueness. Founded in 2022 by Asif Ahamed M.S, e-MAX has come a long way from its beginnings in Cuddalore. When Asif Ahamed M.S first started out, his passion for  eco-friendly cleaning products drove them to quit day job, do tons of research, etc. so that e-MAX can offer you the world's most advanced gadgets. We now serve customers all over the world and are thrilled that we're able to turn our passion into our own website. We hope you enjoy our products as much as we enjoy offering them to you. If you have any questions or comments, please don't hesitate to contact us. Sincerely, Asif Ahamed M.S."
];

$team_members = [
    [
        "name" => "Asif Ahamed M.S",
        "position" => "CEO & Founder",
        "description" => "Asif Ahamed M.S is the driving force behind e-MAX, ensuring we deliver the best products to our customers."
    ],
    [
        "name" => "Balaji B",
        "position" => "Chief Marketing Officer",
        "description" => "Balaji B leads our marketing efforts, bringing creativity and strategy to the team."
    ],
...
$values = [
    ...
    "Innovation" => "We are constantly innovating to bring the best quality products to the market.",
...
<div class="header">
    <div class="container">
        <h2 class="aboutus-head">About Us</h2>
...
<div class="content-section mission-section">
    <div class="container">
        <div class="mission-values">
            <h2 class="aboutus-head">Our Mission</h2>
...
<div class="content-section values-section">
    <div class="container">
        <div class="mission-values">
            <h2 class="aboutus-head">Our Values</h2>
...
<div class="content-section">
    <div class="container">
        <h2 class="aboutus-head">Our Team</h2>
        <div class="row">
