                        ...
                        <tr>
                            ...
                            <td>
                                <form action="cart.php" method="POST" class="d-flex align-items-center">
                                    ...
                                    <input type="submit" class="btn btn-info btn-sm text-white" value="Edit" name="edit_quantity">
                                </form>
                            </td>
                            <td>
                                <span>Rs.</span>
                            ...
                            <td>
                                <form action="cart.php" method="POST">
                                    <input type="hidden" name="product_id" value="<?php echo $product['product_id']; ?>">
                                    <input type="submit" name="remove_product" class="btn btn-danger btn-sm text-white" value="Remove">
                                </form>
                            </td>
                        </tr>
                    <?php }
    ...
    <?php if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) { ?>
        ...
        <div class="checkout-container text-center mt-3">
             <form action="checkout.php" method="POST">
                ...
                <input type="submit" class="btn btn-info text-white" value="Checkout" name="checkout">
             </form>
        </div>
    <?php } ?>
</section>
